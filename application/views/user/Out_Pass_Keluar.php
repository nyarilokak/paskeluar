		...
		<?php $url_data=base_url().'index.php/apps/modul/get_Data_Pass_Out';?>
		<table id="dg" title="Data Out Pass Keluar" class="easyui-datagrid" style ="width:100%;height:auto"
			...
			<div id="dlg" class="easyui-dialog" style="width:60%;padding:30px 60px;"  closed="true" buttons="#dlg-buttons">
			 ...
			 <table width="100%" border="0" class="table-condensed">
			  ...
			  <tr>
				...
				<td>:</td>
				<td> <input name="kilometer"   readonly class="easyui-numberbox" style="width:100%;"  tabindex="6" data-options="required:true" /> </td>
				<td>&nbsp;</td>
				<td>BBM Awal</td>
				<td>:</td>
				<td>
				<select name="bbm" disabled class="easyui-combobox"  tabindex="11" style="width:100%;">
			  ...
			  <tr>
				<td>Tanggal Masuk</td>
				<td>:</td>
				<td><input name="tglmasuk"  class="easyui-datebox" style="width:100%;"  tabindex="7" data-options="formatter:myformatter,parser:myparser, required:true"  /></td>
			 </td>
				<td>&nbsp;</td>
				<td>Jam Masuk</td>
				<td>:</td>
				<td>  <input name="jammasuk"  class="easyui-maskedbox" mask="99:99" style="width:100%;"  tabindex="8" data-options="required:true"/>  </td>
				 </tr>
			  <tr>
				<td>Kilometer Akhir </td>
				<td>:</td>
				<td><input name="kilometerakhir"    class="easyui-numberbox" style="width:100%;"  tabindex="6" data-options="required:true" /> </td>
				<td>&nbsp;</td>
				<td>BBM Akhir</td>
				<td>:</td>
				<td> <select name="bbmakhir"  class="easyui-combobox"  tabindex="11" style="width:100%;">
			  ...
			  <tr>
				<td>Remark </td>
				<td>:</td>
				<td><input name="reason" multiline="true"   class="easyui-textbox" style="width:99%; height:60px"></td>
			   <td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td> 	</td>
