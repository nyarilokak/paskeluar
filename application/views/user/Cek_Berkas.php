	...
	<?php $url_data=base_url().'index.php/apps/modul/get_Data_berkas_Pass_Keluar';?>
	<table id="dg" title="Document Receive  Pass Keluar" class="easyui-datagrid" style ="width:100%;height:auto"
...
<div id="toolbar">
  ...
  <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-pin',plain:true" onclick="doSearch('reset');">Clear search</a> Received Berkas : Double Click Data
</div>
<!--END OF TOOLBAR-->
	...
	function cek_berkas(){
        ...
        var row = $('#dg').datagrid('getSelected');
        if (row){
            $.messager.confirm('Confirm','Are you sure you want to received this document?',function(r){
                if (r){
                    $.post('<?=base_url()?>index.php/apps/modul/Received_pass',{idpass:row.idpass},function(result){
